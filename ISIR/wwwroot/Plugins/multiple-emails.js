(function ($) {
    ...
    $.fn.multiple_emails = function (options) {
        ...
        return this.each(function () {
            ...
            var $input = $('<input onkeyup="Notifykeyup()" id="txtmulemail" type="text" class="multiple_emails-input text-left" />').on('keyup', function (e) { // input
			...
			*/
            function display_email(t, dupEmailCheck) {
                ...
                if (errorEmails.length > 0) {
                    ...
                    $('.ClsReportToClosingRequest').show(); // Add By Jak for Reason show the invalid email addres msg. 
                }
                else {
                    t.val("");
                    refresh_emails();
                    $('.ClsReportToClosingRequest').hide(); // Add By Jak for Reason show the invalid email addres msg. 
                }
            }
