...
*/
RGraph.Bar = function (conf, count) {
    ...
    this.properties =
        {
            ...
            'chart.ylabels': true,
            'chart.ylabels.count': count >= 5 ? 5 : count,
            ...
            'chart.tooltips.css.class': 'RGraph_tooltipbar',
            'chart.tooltips.event': 'onclick',
            'chart.tooltips.highlight': true,
            'chart.tooltips.hotspot.xonly': false,
            'chart.highlight.stroke': 'rgba(0,0,0,0)',
            'chart.highlight.fill': 'rgba(0,0,0,0)',
            'chart.key': null,
